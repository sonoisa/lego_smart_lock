...
# Commands for Interactive Motors (Constant):

# Motor A, B, C, D: 10-byte commands

MOTOR_CONST_INI = b'\x0a\x01\x81'
MOTOR_CONST_MID = b'\x11\x01'
MOTOR_CONST_END = b'\x64\x7f\x03'
